...
private fun CodingEvent.toCodingEventSurrogate() = CodingEventSurrogate(type, payload, firedAt)
private fun CodingEventSurrogate.toCodingEvent() = CodingEvent(type, payload, firedAt)
